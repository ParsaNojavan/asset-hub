...
namespace Sharing.API.BackgroundServices
{
    public sealed class AssetDeletedConsumer : BackgroundService, IAsyncDisposable
    {
        ...
        public AssetDeletedConsumer(IServiceScopeFactory scopeFactory,
            IOptions<RabbitMqOptions> options)
        {
            ...
            _queueName = "share.asset-deleted.queue";
        }
        ...
        private async Task HandleMessageAsync(object sender, BasicDeliverEventArgs e)
        {
            ...
            try
            {
                ...
                var evt = JsonSerializer.Deserialize<AssetDeletedEvent>(json);
                ...
                var cleanup = scope.ServiceProvider.GetRequiredService<ISharedUserCleanUpService>();

                await cleanup.CleanupAsync(evt.AssetId);
